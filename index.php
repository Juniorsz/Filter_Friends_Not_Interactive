...
<head>
	<meta charset="UTF-8">
	<title>Lọc Bạn Bè Không Tương Tác</title>
...
<body>
	...
	<script type="text/javascript">
		...
		function Ranking() {
		    ...
		    setTimeout((e) => {
		        $("#result-msg").empty().html('<img src="https://www.ochealthiertogether.org/content/global/application/indicators/gauges/target-met.png" width="30" height="30" /> Thành Công!');
		        show();
		    }, 5000)
		}
